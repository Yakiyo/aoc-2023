...
export { partTwo } from './part_2.ts';

// This was the original solution i wrote. It works, cz i tested it with the demo inputs
// and they returned expected values. But when using the entire input, the function takes
// too long. So i copy pasted a solution from someone else in [./part_2.ts] which works quickly
export function _partTwo(input: string) {
	const [direction_input, node_input] = input.split('\n\n');
